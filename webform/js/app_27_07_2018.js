...
//    $scope.otherSectors = false;
    ...
    $scope.nodeSectorChanged = function(node, selected, event) {
        ...
        /*console.log('$scope.current.PAM.Table1.Sectors');
        console.log($scope.current.PAM.Table1.Sectors);*/
        ...
        /*console.log('Table1');
        console.log(Table1);
        console.log('Table1.table1_Description');
        console.log(Table1.table1_Description);*/
    }
