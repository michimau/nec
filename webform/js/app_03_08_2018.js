...
webform.controller('NECsCtrl', ['$scope', '$rootScope', '$location', 'dataRepository', '$timeout', '$translate','$anchorScroll','$window','$filter', function($scope, $rootScope, $location, dataRepository, $timeout, $translate,$anchorScroll,$window,$filter) { 
    ...
    $scope.sectorsData = require('./treeData/sectorsData.json');
    $scope.unionPolicyData = require('./treeData/unionPolicyData.json');
    $scope.pollutantsData = require('./treeData/pollutantsData.json');
    //$scope.agricultureData = require('./agricultureData.json');
    $scope.mandatoryPollutant = 0;
    $scope.policyInstrumentsData = require('./treeData/policyInstrumentsData.json');
    $scope.implementationStatusData = require('./treeData/implementationStatusData.json');
    $scope.projectionsScenarioData = require('./treeData/projectionsScenarioData.json');
    $scope.AmmoniaEmissionsData = require('./treeData/ammoniaEmissionsData.json');
    $scope.AmmoniumCarbonateFertilisersData = require('./treeData/ammoniumCarbonateFertilisersData.json');
    $scope.AmmoniaEmissionsLivestockData = require('./treeData/ammoniaEmissionsLivestockData.json')

    $scope.OpenFieldBurningData = require('./treeData/openFieldBurningData.json')
    ...
    $scope.nodeAmmoniaEmissionsChanged = function(node, selected, event) {
      ...
      console.log('$scope.current.PAM.Table1.Agriculture.AmmoniaEmissions');
      console.log($scope.current.PAM.Table1.Agriculture.AmmoniaEmissions);
    }
